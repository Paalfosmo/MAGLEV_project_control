...
subplot(3,1,1)
grid on; hold on;
plot(t_span, x(:,1:3)-x_new(:,1:3), 'linewidth', 2)
ylabel('States (x/y/z)')
title("Deviation between the values of the original and the decomposed system")

subplot(3,1,2)
grid on; hold on;
plot(t_span, y-y_new, 'linewidth', 2)
ylabel('Measurements')

subplot(3,1,3)
grid on; hold on;
plot(t_span, u-u_new, 'linewidth', 2)
ylabel('Inputs')
